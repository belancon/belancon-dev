...
class Hukum extends CI_Controller 
{
	...
	public function kebijakan_privasi() {
		...
		//set meta tag
                ...
                //set layout
                $this->template->set_layout('kebijakan_privasi'); // nama file page nya, tanpa extension php
        ...
        public function syarat_ketentuan() {
                ...
                //set layout
                $this->template->set_layout('syarat_ketentuan'); // nama file page nya, tanpa extension php
                $this->template->render(); // terakhir render
        }
}