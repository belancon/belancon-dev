...
class Member extends MY_Controller 
{
    ...
    public function icon() {
        ...
        $this->_loadjs();
        $this->_loadpart();
        $this->template->set_part('script', '_scripts/member_icon');
        $this->_loadscript();
        //set layout
        $this->template->set_layout('layouts/custom');
    ...
    public function add_icon() {
        ...
        $this->_loadjs();
        $this->_loadpart();
        $this->template->set_part('script', '_scripts/member_add_icon');
        $this->_loadscript();
    ...
    public function update_icon($id) {
        ...
        $this->_loadjs();
        $this->_loadpart();
        $this->template->set_part('script', '_scripts/member_update_icon');
        $this->_loadscript();
        //get categories
        $data['categories'] = $this->category_model->get_all();
        //set layout
    ...
    public function profile() {
        ...
        $this->_loadjs();     
        $this->_loadpart();
        $this->template->set_part('script', '_scripts/member_profile');
        $this->_loadscript();
        //set layout
        $this->template->set_layout('layouts/custom');
    ...
    public function change_profile() {
        ...
        $this->_loadjs();
        $this->_loadpart();
        $this->template->set_part('script', '_scripts/member_change_profile');
        $this->_loadscript();
        //set layout
        $this->template->set_layout('layouts/custom');
    ...
    public function setting_link_account() {
        ...
        $this->_loadjs();
        $this->_loadpart();
        $this->template->set_part('script', '_scripts/member_link_account');
        $this->_loadscript();
        //set layout
        $this->template->set_layout('layouts/custom');
    ...
    public function change_password() {
        ...
        $this->_loadjs();
        $this->_loadpart();
        $this->template->set_part('script', '_scripts/member_change_password');
        $this->_loadscript();
        //set layout
        $this->template->set_layout('layouts/custom');
